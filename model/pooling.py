...
# ======================================================================================================================
# My own pooling things. Probably not used
# ======================================================================================================================
...
class AttentionPooling(nn.Module):
    def __init__(self, input_dim,
        ...
        self.feature_embedding = nn.Parameter(self.scale * torch.randn(input_dim))
        self.linear = nn.Linear(input_dim, output_dim)
        self.tanh = torch.tanh
        self.projection = nn.Parameter(self.scale * torch.randn(input_dim, output_dim))

    def forward(self, x):
        attn_weights = self.feature_embedding @ x.transpose(-2, -1) * self.scale
